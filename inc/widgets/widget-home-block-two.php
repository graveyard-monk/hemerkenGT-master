 ...
 * @since      1.0.0
 */
class hemerken_gt_Block_Two_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			echo '<div class="content-block content-block-2 clear">';
				...
				// Column first post
				hemerken_gt_home_posts_first( $args, $instance );

				// Column first post
				hemerken_gt_home_posts_second( $args, $instance );
...
function hemerken_gt_home_posts_first( $args, $instance ) {
	...
	$query = apply_filters( 'hemerken_gt_home_two_columns_1_args', $args );
...
function hemerken_gt_home_posts_second( $args, $instance ) {
	...
	// Allow dev to filter the post arguments.
	$query = apply_filters( 'hemerken_gt_home_two_columns_2_args', $args );
