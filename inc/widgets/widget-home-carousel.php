 ...
 * @since      1.0.0
 */
class hemerken_gt_Carousel_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-hemerken_gt-home-carousel',
			'description' => __( 'Display posts in carousel. Only use for the "Homepage Bottom" widget area.', 'hemerken' )
		);

		// Create the widget.
		parent::__construct(
			'goblin-home-bottom-carousel',          // $this->id_base
			__( '&raquo; Home Carousel', 'hemerken' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			$query = apply_filters( 'hemerken_gt_home_carousel_args', $args );
